component Dashboard {
  ...
  fun renderStats(stats : Stats) : Html {
      	<div class="row">
							<div class="col-lg-3 col-md-6">
						      <ColourMetric title="Total Transactions" value={stats.totalFastTransactions + stats.totalSlowTransactions} icon="tasks" colour="bg-gradient-secondary" />
							</div>
							<div class="col-lg-3 col-md-6">
								<ColourMetric title="Latest Difficulty" value={stats.difficulty} icon="dashboard" colour="bg-gradient-success" />
							</div>
							<div class="col-lg-3 col-md-6">
								<ColourMetric title="Total Fast Blocks" value={stats.totalFastBlocks} icon="cube" colour="bg-gradient-danger" />
							</div>
							<div class="col-lg-3 col-md-6">
								<ColourMetric title="Total Slow Blocks" value={stats.totalSlowBlocks} icon="cube" colour="bg-gradient-info" />
							</div>
						</div>
  }
  ...
  get renderNoStats : Html {
        	<div class="row">
							<div class="col-lg-3 col-md-6">
						      <ColourMetric title="Total Transactions" value={0} icon="tasks" colour="bg-gray" />
							</div>
							<div class="col-lg-3 col-md-6">
								<ColourMetric title="Latest Difficulty" value={0} icon="dashboard" colour="bg-gray" />
							</div>
							<div class="col-lg-3 col-md-6">
								<ColourMetric title="Total Fast Blocks" value={0} icon="cube" colour="bg-gray" />
							</div>
							<div class="col-lg-3 col-md-6">
								<ColourMetric title="Total Slow Blocks" value={0} icon="cube" colour="bg-gray" />
							</div>
						</div>  
  }
